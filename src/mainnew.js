...
class LINE extends LineAPI {
    ...
    get myBot() {
        const bot = ['u65224f4e8812136f01b25275a54b5aef'];
        return bot; 
    }
    ...
    poll(operation) {
     ...
     {
let arifq = new Message();
arifq.to = operation.param1;
arifq.text = "Woooiii!!! Jangan Main Kick Sembarangan!!! Aku Kick Kamu Yaa, Byeee!!!"
this._client.sendMessage(0,arifq);
     }
            // op1 = group nya
            // op2 = yang 'nge' kick
            // op3 = yang 'di' kick
...
if(operation.type == 11) { //bukattupQR
     {
let arifuye = new Message();
arifuye.to = operation.param1;
arifuye.text = "Jangan Ubah Gambar Dan Nama Group/Jangan Dimainin QR-nya -__- Aku Kick Yaa !"+"Cuma Admin Yang Bisa!!!"
this._client.sendMessage(0,arifuye);
     }
            if(!this.isAdminOrBot(operation.param2)){
                this._kickMember(operation.param1,[operation.param2]);
            } 
...
let arifuye = new Message();
arifuye.to = operation.param1;
arifuye.text = "Byee~Byee... Jangan Balek Lagi Yaa Ke Group... Bikin Semak Aja... Makasih ^_^"
...
let arifq = new Message();
arifq.to = operation.param1;
arifq.text = "Terima Kasih Telah Invite Saya Di Group Anda ^_^\n\nSilahkan Ketik [/help] Untuk Mengetahui Command Bot Kami.\n\n~ARIF~"
,"Invite Juga Arif II Kesini ^_^"

this._client.sendMessage(0,arifq);
}
{
let arif = new Message();
arif.to = operation.param1;
arif.text = "Invite Juga Arif II Kesini ^_^"

this._client.sendMessage(0,arif);
  }
}
...
let arifq = new Message();
arifq.to = operation.param1;
arifq.text = "Hallo Selamat Datang ^_^ Jangan Nakal Yaa Di Group Ini ^_^"
...
let arifq = new Message();
arifq.to = operation.param1;
arifq.text = "Kok Dibatalin? Emangnya Dia Siapa?"
...
let arifq = new Message();
arifq.to = operation.param1;
arifq.text = "Thx For Add Me 😘 Invite Me To Your Group ^_^"
this._client.sendMessage(0,arifq);
}
...
let arifq = new Message();
arifq.to = operation.param1;
arifq.text = "Jangan Main Invite Sembarangan... Siapa Tau Kicker 😧"
...
this.command('Halo', ['halo disini Arif','kamu siapa?']);
this.command('Hi', ['hi disini Arif','kamu siapa?']);

this.command('Arif', ['Apa kak? ada yg bisa dibantu?','Ketik /help untuk bantuan']);
