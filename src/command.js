...
//class LINE extends LineAPI {
    ...
    OnOff() {
        if(this.isAdminOrBot(this.messages.from)){
            ...
            this._sendMessage(this.messages,`Ketik Keyword Ini Untuk Melihat Admin : Admin1                      Admin2                      Admin3                      Admin4                      Admin5                      Admin6`);
        }
...
creator() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'u65224f4e8812136f01b25275a54b5aef'}
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
...
admin2() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'ub21eb3d440e0dfd640eef9f2fb5ce02d' }
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
...
admin3() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'u782cdf7a9fd2545c84a0cd86f418e9f7' }
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
...
admin4() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'ue4e13b0a41d848845489374e671c6861' }
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
...
admin5() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'u799da4e06d50e1775cfcff1f3e59df03' }
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
...
admin6() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'u00d73ba3e810e651e8c5690723e1b5bf' }
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
...
bot2() {
        let msg = {
            ...
            contentPreview: null,
            contentMetadata: 
            { mid: 'u45ac75d00ea685c99651e108b666c444o' }
        }
        Object.assign(this.messages,msg);
        this._sendMessage(this.messages);
 }
